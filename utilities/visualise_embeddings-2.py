...
def plotEmbeddings(args):
	...
	reduction_train = reduction[0:27732,:]
	reduction_test = reduction[27732:,:]
	...
	scatter(reduction_train, embeddings1['labels'], '/content/drive/MyDrive/foram-MetricLearningIdentification-master/output/fold_0/train_embeddings')
	scatter(reduction_test, embeddings2['labels'], '/content/drive/MyDrive/foram-MetricLearningIdentification-master/output/fold_0/test_embeddings')
